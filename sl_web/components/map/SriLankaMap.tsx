  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center p-4 md:p-8">
      ...
      >
        ...
        {/* --- OR --- */}
        {/* Option 1: If using SVGR to import SVG as a React component for more control */}
        {/* <SriLankaShape
          className={cn(
            "w-full h-full select-none drop-shadow-xl transition-colors duration-300",
            // Apply fill/stroke directly if SVG component allows (requires paths to have no hardcoded fill)
            effectiveTheme === 'dark' ? "fill-gray-700 stroke-gray-500" : "fill-gray-200 stroke-gray-400"
          )}
        /> */}
